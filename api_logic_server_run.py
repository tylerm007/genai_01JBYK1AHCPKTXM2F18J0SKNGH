...
#
#    (v 12.01.12, November 05, 2024 16:39:02)
#
...
api_logic_server__version = '12.01.12'
api_logic_server_created__on = 'November 05, 2024 16:39:02'
...
if __name__ == "__main__":
    ...
    msg = f'API Logic Project Loaded (WSGI), version 12.01.12\n'
    msg += f'.. startup message: {start_up_message}\n'
