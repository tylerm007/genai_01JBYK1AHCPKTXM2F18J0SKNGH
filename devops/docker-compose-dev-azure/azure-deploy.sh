...
resourcename="dogwalkingbusiness"  # lower case, only
resourcegroup="dogwalkingbusiness_rg"
...
# git clone https://github.com/apilogicserver/dogwalkingbusiness.git
# cd dogwalkingbusiness
...
az group create --name dogwalkingbusiness_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group dogwalkingbusiness_rg --sku S1 --is-linux
az container create --resource-group dogwalkingbusiness_rg --name dogwalkingbusiness --image apilogicserver/dogwalkingbusiness:latest --dns-name-label dogwalkingbusiness --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//dogwalkingbusiness.westus.azurecontainer.io:5656'
